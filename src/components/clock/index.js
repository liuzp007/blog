...
export function clockCursor(options) {
    ...
    const dateColor = (options && options.dateColor) || "origin";
    const faceColor = (options && options.faceColor) || "#F5F6F7";
    const secondsColor = (options && options.secondsColor) || "origin";
    const minutesColor = (options && options.minutesColor) || "#F5F6F7";
    const hoursColor = (options && options.hoursColor) || "#F5F6F7";
