...
const LINK_BASE = [
  ...
  'hover:translate-x-[2px] hover:border-[var(--border-subtle)] hover:bg-[color-mix(in srgb, var(--color-white) 6%, transparent)] hover:text-[var(--color-text-primary)] hover:shadow-[0_0_0_2px_var(--focus-ring)]',
  'focus-visible:translate-x-[2px] focus-visible:border-[var(--border-subtle)] focus-visible:bg-[color-mix(in srgb, var(--color-white) 6%, transparent)] focus-visible:text-[var(--color-text-primary)] focus-visible:shadow-[0_0_0_2px_var(--focus-ring)] focus-visible:outline-none'
].join(' ')
        ...
        {items.map(i => (
          ...
          >
            <a href={`#${i.id}`} className={clsx(LINK_BASE, TONE[i.level])}>
              <span
                className="toc__marker mt-[0.45em] h-2 w-2 rounded-[var(--radius-pill)] border border-[color-mix(in srgb, var(--color-indigo-500) 20%, transparent)] bg-[color-mix(in srgb, var(--color-indigo-500) 10%, transparent)] shadow-[0_0_0_2px_transparent] transition-colors duration-200 group-hover:border-[var(--color-accent-cyan)] group-hover:bg-[var(--color-accent-cyan-soft)] group-focus-visible:border-[var(--color-accent-cyan)] group-focus-visible:bg-[var(--color-accent-cyan-soft)]"
                aria-hidden="true"
              />
