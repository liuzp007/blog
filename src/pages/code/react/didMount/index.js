...
const list = {
  ...
  ·清理任何在componentDidMount()中创建的DOM元素(elements);
  `,
}
export default function ComponentDidMount(props) {
  return (
    <div>
      <h2 className='titles'>componentDidMount and componentWillUnmount</h2>
